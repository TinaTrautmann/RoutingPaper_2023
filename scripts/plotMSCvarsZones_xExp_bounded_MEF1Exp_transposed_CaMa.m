...
function [sname, T_corr, sp, T_MEF, T_RMSE, T_corrMean, T_MEFMean] = plotMSCvarsZones_xExp_bounded_MEF1Exp_transposed_CaMa(dataNames, dataObs, dataXX, dataUnc, zoneNames, zoneIdx, pix_a, unitNames, col)
...
tmpT{1} = 'obs';
if nrows==1
    l  = legend([p_obs, p_1, p_2, p_3, p_4, p_5], tmpT, 'Position', [.44 0 .12 .07], 'box', 'off', 'Orientation', 'Horizontal','Fontsize', 9, 'NumColumns',3);
else                    
    l  = legend([p_obs, p_1, p_2, p_3, p_4, p_5], tmpT, 'Position', [.44 0 .12 .07], 'box', 'off', 'Orientation', 'Horizontal','Fontsize', 9, 'NumColumns',3);
end
