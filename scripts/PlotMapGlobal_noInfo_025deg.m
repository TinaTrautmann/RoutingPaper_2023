function [ sp ] = PlotMapGlobal_noInfo_025deg(name, addinfo, units, lat, lon, data, colLim, col, colLabel, cbar, histPlot)
% plots data onto a global Map in 0.25deg also land area and large rivers
