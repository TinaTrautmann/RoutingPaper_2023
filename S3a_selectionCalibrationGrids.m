...
%!!
globData = load([pthX 'people/ttraut/SINDBAD_Routing/data/GRUNrouted_effVel_0_5.mat']) %wRiver, Qriver, lat, lon, xDays
...
%!!
load([pthX 'work_3/sindbad/project/PhDTina/sindbad/data/input/globalBaseline_validCali/lat_lon_global.mat'])
